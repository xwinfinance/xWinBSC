 ...
 */
contract xWinLuckyWinner is VRFConsumerBase, IBEP20, BEP20("Lucky Draw", "LUCKY") {
    ...
    uint public minimalBalanceLP = 1 * 10 ** 18; 
    uint public minimalBalanceXWIN = 1 * 10 ** 18; 
    uint public luckypid = 0;
    uint public lppid = 4;
    uint public xWINpid = 3;
    uint public numberOfPrizes = 2;
    ...
    xWinDefi _xWinDefi = xWinDefi(address(0x788E09a42b64d5C4D5887eB426da2CA810a93D8e)); // this is testnet
    address LINKaddress = address(0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06);
    address public burnAddress = address(0x000000000000000000000000000000000000dEaD);
    address public executorAddress = address(0x5D450b7A2bAFbc071cF1313099C3744f91c3BC24);
    ...
    function claimPrizes(uint _pid) public {
    ...
    function getXWINLPStaked() public view returns (uint) {
    ...
    function _expandGetRandom(uint256 randomValue, uint256 n) internal view returns (uint256[] memory expandedValues) {
        ...
        for (uint256 i = 0; i < n; i++) {
            uint tmpOut = uint256(keccak256(abi.encode(randomValue, i)));
            expandedValues[i] = (tmpOut % userAddressArray.length);
        }
